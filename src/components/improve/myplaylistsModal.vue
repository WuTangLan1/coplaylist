        ...
        <v-card class="d-flex align-center" :style="{ backgroundColor: '#220956' }" flat tile>
          <v-row class="ma-0" align="center" justify="start">
            <v-col cols="auto" class="pa-0">
              <v-img :src="require('@/assets/images/explanation-container/improve.png')" class="white--text" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="60px" contain />
            </v-col>
            <v-col class="d-flex align-center justify-start">
              <v-card-title class="text-h4 py-2 px-2 text-white">Improve Your Playlist</v-card-title>
            </v-col>
          </v-row>
        </v-card>
      </v-col>
